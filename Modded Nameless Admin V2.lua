--damian's ver, all credits to qipu for practically everything
repeat
	task.wait()
until game:IsLoaded()
...
Command.Add(
	{"2007anims", "2007a"},
	{"2007anims / 2007a", "Makes your R6 character have 2007anims (must be r6)"},
	{"None"},
	function()
	wait(1)
	loadstring(game:HttpGet('https://pastebin.com/raw/TkeWvsCh'))()
	end
)
Command.Add(
	{"R15from2016", "R15alternativeanim", "2016R15"},
	{"R15from2016 / R16alternativeanim / 2016R15", "Makes you have R15 2016 anims"},
	{"None"},
	function()
	loadstring(game:HttpGet('https://pastebin.com/raw/MYjwe7Ug'))()
	end
)
...
Command.Add(
	{"DisableMobileAutoJump", "DMAJ"},
	{"DisableMobileAutoJump / DMAJ", "Disables mobile auto jump"},
	{"None"},
	function()
	if
	...
	UIFuncs.SendNotification("Nameless Admin", "Disabled!", 5)
	else
	UIFuncs.SendNotification("Nameless Admin", "AutoJump already disabled!", 5)
    end
   end
)

Command.Add(
	{"EnableMobileAutoJump", "EMAJ"},
	{"EnableMobileAutoJump / EMAJ", "Enables mobile auto jump"},
	{"None"},
	function()
	if
	game.Players.LocalPlayer.Character.Humanoid.AutoJumpEnabled == false
	then
	game.Players.LocalPlayer.Character.Humanoid.AutoJumpEnabled = true
	UIFuncs.SendNotification("Nameless Admin", "Enabled!", 5)
	else 
	UIFuncs.SendNotification("Nameless Admin", "Autojump already enabled!", 5)
	end
   end
)
...
Command.Add(
	{"Exit", "X"},
	{"Exit / X", "Closes the Roblox client"},
	{"None"},
	function()
    game:shutdown()
    end
...
Command.Add(
	{"MobileVR", "MVR"},
	{"MobileVR / MVR", "Fake VR for mobile"},
	{"None"},
	function()
	loadstring(game:HttpGet('https://pastebin.com/raw/Zf64fu3W'))()
	end
)
...
Command.Add(
	{"UnModdedVersion", "UMV"},
	{"UnModdedVersion / UMV", "Reboots Nameless 2.0"},
	{"None"},
	function()
	UIFuncs.SendNotification("Nameless Admin", "Launching undone version!", 2)
	wait(2)
    loadstring(game:HttpGet("https://rawscripts.net/raw/Universal-Script-Nameless-Admin-V2-UNFINISHED-source-code-9359", true))()
    end
)
...
Command.Add(
	{"WallWalk", "WWK"},
	{"WallWalk / WWK", "Walk on walls"},
	{"None"},
	function()
	loadstring(game:HttpGet('https://pastebin.com/raw/s4FjP97j', true))()
	end
)

Command.Add(
	{"Telekenisis", "TLK"},
	{"Telekenisis / TLK", "Gives you telekenisis"},
	{"None"},
	function()
Range = "Min"
...
Command.Add(
	...
	function()
		UIFuncs.PopupTrigger(
			"Nameless Admin",
			"This command will basically make your game look bad are you sure you want to run it? (Can't be untoggled)",
			function()
...
Command.Add(
	...
	function()
		...
		UIFuncs.SendNotification("Nameless Admin", "Mobile friendly", 5)
	end
)
...
Command.Add(
	{"CheckPrefix", "CPre"},
	{"CheckPrefix / CPre", "Checks the Prefix"},
	{"None"},
	function(Prefix)
	UIFuncs.SendNotification("Nameless Admin", Settings.Prefix, 5)
	end
)
Command.Add(
	{"Touchfling", "TF"},
...
Command.Add(
	{"FateAdmin", "FAN"},
	{"FateAdmin / FAN", "Executes Fate's Admin"},
	{"None"},
	function()
...
Command.Add(
	{"HomeBrewAdmin", "HBA"},
	{"HomeBrewAdmin / HBA", "Executes homebrew admin"},
	{"None"},
	function()
...
Command.Add(
	...
	function()
		...
		UIFuncs.SendNotification("Nameless Admin", "Shouldn't work, SimpleSpy discontinued", 5)
	end
)
Command.Add(
	{"Dumbass", "Da"},
	...
	{"None"},
	function()
	UIFuncs.SendNotification("Nameless Admin", "Done", 5)
		local Replace = {
			["r"] = "w",
			["l"] = "w",
			["ove"] = "uv",
...
Command.Add(
	{"FPSUnlock", "FPSU"},
	{"FPSUnlock / FPSU", "Unlocks your FPS to whatever number you put"},
	{"Number"},
	function(Number)
	setfpscap(tonumber(Number))
	end
)
...
Command.Add(
	{"Loaded", "LDD"},
	{"Loaded / LDD", "Sends a notification if you're fully loaded"},
	{"None"},
	function()
	if
	game:IsLoaded()
	then
	UIFuncs.SendNotification("Nameless Admin", "Game is Loaded!", 5)
	else repeat until game:IsLoaded() == true
	end
   end
 )
