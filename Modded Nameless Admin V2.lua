...
Command.Add(
	{"UnModdedVersion", "UMV"},
	{"UnModdedVersion / UMV", "Reboots Nameless 2.0 (Unmodded by Damian)"},
	{"None"},
	function()
	UIFuncs.SendNotification("Damian's Admin", "Launching Nameless' version!", 2)
	wait(2)
...
Command.Add(
	...
	function()
		...
		UIFuncs.SendNotification("Nameless Admin", "Dex script changed by Damian (this is mobile friendly)", 5)
	end
)
...
Command.Add(
	...
	{"None"},
	function(Prefix)
	UIFuncs.SendNotification("Nameless Admin (modified by damian)", Settings.Prefix, 5)
	end
)
Command.Add(
	{"Touchfling", "TF"},
...
Command.Add(
	...
	function()
		...
		UIFuncs.SendNotification("Nameless Admin (modified)", "Shouldn't work, SimpleSpy discontinued", 5)
	end
)
Command.Add(
	{"Dumbass", "Da"},
	...
	{"None"},
	function()
	UIFuncs.SendNotification("Nameless Admin (Modified)", "Modified by Damian :3", 5)
		local Replace = {
			["r"] = "w",
			["l"] = "w",
			["ove"] = "uv",
